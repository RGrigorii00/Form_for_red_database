...
namespace WindowsFormsApp20
{
    public partial class Form5 : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["PRODUCT_ID"].Value.ToString()) && !string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["PRODUCT_NAME"].Value.ToString()) && !string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["PRICE"].Value.ToString()) && !string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["KOLICHESTVO"].Value.ToString()))
            {
                string insertQuery = "INSERT INTO PRODUCT VALUES (@value1, @value2, @value3, @value4)";
                ...
                try
                {
                    using (FbConnection connection = new FbConnection(textBox1.Text))
                    {
                        ...
                        using (FbCommand command = new FbCommand(insertQuery, connection))
                        {
                            ...
                            command.Parameters.AddWithValue("@value1", dataGridView1.CurrentRow.Cells["PRODUCT_ID"].Value);
                            command.Parameters.AddWithValue("@value2", dataGridView1.CurrentRow.Cells["PRODUCT_NAME"].Value);
                            command.Parameters.AddWithValue("@value3", dataGridView1.CurrentRow.Cells["PRICE"].Value);
                            command.Parameters.AddWithValue("@value4", dataGridView1.CurrentRow.Cells["KOLICHESTVO"].Value);
        ...
        private void deleteButton_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                int selectedId = (int)dataGridView1.SelectedRows[0].Cells["PRODUCT_ID"].Value;
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                if (!string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["PRODUCT_ID"].Value.ToString()) && !string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["PRODUCT_NAME"].Value.ToString()) && !string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["PRICE"].Value.ToString()) && !string.IsNullOrEmpty(dataGridView1.CurrentRow.Cells["KOLICHESTVO"].Value.ToString()))
                {
                    string insertQuery = "UPDATE PRODUCT SET PRODUCT_ID = @value1, PRODUCT_NAME = @value2, PRICE = @value3, KOLICHESTVO = @value4 WHERE PRODUCT_ID = @value1";
